...
const page = () => {
    ...
    return (
        ...
        <div className='py-12 container text-center mx-auto'>
            <h1 className='text-3xl font-bold'>Login/Signup To Get Started</h1>
            <div className="buttons">
                <div className=" flex flex-col gap-2 min-h-screen items-center  pt-10 md:pt-20">


                    <button
                        className=" flex w-64 justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    ...
                    <button
                        className=" flex w-64 justify-center justify-centeritems-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
